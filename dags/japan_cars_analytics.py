...
def _run_parsing(**context):
    brand_model = Variable.get("brand_model", default_var="honda/vezel")
    option_cars = Variable.get("option_cars", default_var="rate-4=4&rate-4-5=4.5&year-from=2020&year-to=2023")
